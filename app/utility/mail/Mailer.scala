...
class MailerImpl(
  ...
  val username: String = ConfigFactory.load().getString("application.username")
  ...
  def welcome(email: String, name: String, link: String)(
    ...
    _sendEmailAsync(email)(
      subject = Messages("mail.welcome.subject", appName),
      bodyHtml = mails.welcome(appName = appName, name = name, link = link),
      bodyText = mails.welcomeTxt(appName = appName, name = name, link = link)
    )
  }
  ...
  def postSignUpWelcome(email: String, name: String)(
    ...
    _sendEmailAsync(email)(
      subject = Messages("mail.postSignUpWelcome.subject", appName, name),
      bodyHtml =
        mails.postSignUpWelcome(appName = appName, name = name, username = username),
      bodyText =
        mails.postSignUpWelcomeTxt(appName = appName, name = name, username = username)
    )
  }
