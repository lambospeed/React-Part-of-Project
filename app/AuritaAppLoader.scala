...
import aurita.controllers.auth.SocialAuthController
...
class AppComponents(context: Context) extends AuritaSlickComponents(context)
  ...
  import aurita.controllers.DatasetsController
  ...
  import aurita.controllers.map.daos.{ MapControllerDAO, MapControllerDAOImpl }
  ...
  lazy val mapControllerDAO: MapControllerDAO = wire[MapControllerDAOImpl]
  lazy val datasetController: DatasetsController = wire[DatasetsController]
